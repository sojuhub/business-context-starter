...
class CopyFirstContractTests(unittest.TestCase):
    ...
    def test_entry_is_copy_first(self):
        ...
        self.assertIn("No manual plugin installation", text)
    ...
    def test_verified_remote_url_in_copy_prompt(self):
        text=(ROOT/"COPY_PROMPT.md").read_text()
        self.assertIn("https://github.com/sojuhub/business-context-starter", text)
    ...
    def test_release_requires_real_pinned_source(self):
        ...
        self.assertIn("explicit public allowlist", text)
