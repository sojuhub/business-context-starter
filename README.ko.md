...
1. **기존 연결부터 확인합니다.** 이메일·문서·회사 Wiki 도구를 찾고, 이미 있는 자료로 회사 요약을 시작합니다. 비공개 자료는 업무 범위를 한 번 정한 뒤 실제로 읽습니다. 웹사이트나 짧은 사업 설명으로도 시작할 수 있습니다.
...
기록된 읽기 증거를 검사하며, 그 자체가 실제 계정 접근 성공을 입증하지는 않습니다.
